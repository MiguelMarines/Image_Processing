// =========================================================================== //
//                 ADD CONTRAST TO A POORLY CONTRSASTED IMAGE                  //
// =========================================================================== //
// Author: Miguel Marines                                                      //
// Activity: Add Contrast to a Poorly Contrasted Image                         //
// =========================================================================== //
...
//----------------------------------------------------------------------------//
//                   Add Contrast to a Poorly Contrasted Image                //
//----------------------------------------------------------------------------//
void userdefined ()
{
	unsigned char Pixel;
	...
	float ScaleFactor;
	// Minimo y maximo pixel de la imagen actual.
	int min = 255;
	int max = 0;
	...
	for (row = 0; row < 512; row++)
  {
		for(col = 0; col < 512; col++)
    {
			...
			// 2. Encontrar min y max.
			if(Pixel < min) min = Pixel;
			if(Pixel > max)	max = Pixel;
		}
	}
	
	printf("Pixel Valor Minimo: %d\n", min);
	printf("Pixel Valor Maximo: %d\n", max);

	// 3. Encontrar el factor de escalamiento.
	ScaleFactor = 255.0/(max - min);
	
	// 4. Proccesamiento de los pixel - Estiro el histograma.
	for (row = 0; row < 512; row++)
  {
		for(col = 0; col < 512; col++) 
    {
